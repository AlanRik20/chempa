...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2023 a las 15:51:46
...
INSERT INTO `asistencia` (`Id_asistencia`, `empleado`, `DNI`, `Fecha_entrada`) VALUES
(3, 'Tici', '46154458', '2023-11-21 14:22:00');
...
(10, 31, 6, 17, 7, '20-46154567-5', 13),
(11, 32, 3, 18, 8, '26798308092', 14);
...
(1, 1, 1, '2023-11-15', 1, 1),
(2, 2, 1, '2023-11-15', 2, 2),
(3, 1, 2, '2023-11-15', 2, 1);
...
(31, 'Alan', 'riquelme', '2005-04-22'),
(32, 'anna', 'anna', '2222-02-01');
...
(5, 'jamon y queso', 3000, 'Jamon cocido seleccionado con queso mozzarella', 'IMG-20230705-WA0094.jpg'),
...
(61, 'Empanada salteña', 300, 'Empanada Salteña', '1935769.png'),
(63, 'empanada arabe', 30000, 'Uva papa molida especial de salta', 'Sin Imagen'),
(65, 'empanada salteña', 40000, 'Uva papa molida especial de salta', 'Sin Imagen');
...
(13, 'alan', 'rik', '2023-11-08'),
(14, 'anna', 'anna', '2023-11-08');
...
--
ALTER TABLE `compra_ficticia`
  MODIFY `id_compra_ficticia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `detalle_pedidos`
  MODIFY `id_detalle_pedidos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `detalle_productos`
--
ALTER TABLE `detalle_productos`
  MODIFY `id_detalle_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `stock_productos`
  MODIFY `id_stock_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
