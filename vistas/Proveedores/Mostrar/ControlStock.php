...
.otro-titulo h2 {
    ...
    <div class="contPag">
        ...
        <table class="tabla1">
            ...
            $mostrar=mysqli_query($mysqli,"SELECT i.*, ti.descripcion AS nombre_tipo_insumo, p.nombre_per AS Nombre, p.apellido AS Apellido, si.cantidad AS cantidad, tm.Medida AS Medida
            FROM insumos i
            ...
            LEFT JOIN tipo_medida tm ON si.id_tipo_medida = tm.id_tipo_medida WHERE i.id_proveedor=$proveedor
        ...
        if ($mostrar->num_rows> 0){
            ...
            while($resultado = mysqli_fetch_assoc($mostrar)){ 
                ...
                echo"<td>
                <form action='../../Control de Stock/Stock Insumos/Modificar/ModificarInsumo.php' method='POST'>
                ...
                echo"<td>
                <form action='../../Control de Stock/Stock Insumos/Eliminar/eliminarInsumo.php' method='POST'>
                <input type='hidden' name='id_insumo' value='".$resultado['id_insumo']."'>
