...
.otro-titulo h2 {
    ...
    <div class="contPag">
        ...
        <form action="../Gerente/MenuGerente.html" method="POST">
        ...
        <table class="tabla1">
            ...
            INNER JOIN tipo_contactos ON contactos.id_tipo_contacto = tipo_contactos.id_tipo_contacto ORDER BY personas.apellido ASC ;
            ");
